        ...
        <a href="scripts/logout.php"> <span class="glyphicon glyphicon-log-out" aria-hidden logout="true" style="font-size: 40px;  color: white;" id="logo"> </span></a>
         ...
         <div class="container">
            ...
            <?php endif; ?>
                 ...
                 <tr>
                <td>
                    Change status to ("approved" will automatically send data to finance) : 
                </td>
                
                <td class="right">
                    <form name="change" action="scripts/save.php" method="post" onsubmit="return confirm('Are you sure?')">
                        ...
                        ?>
                            ...
                            <div>
                        <input type="submit" class="btn btn-warning btn-block active"  value="Update Status" name="change" />
