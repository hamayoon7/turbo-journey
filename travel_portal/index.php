            ...
            <div class="loginparent">
                ...
                <div class="login">
                   ...
                   <div class="form-group">
                       <label for="usr"> <h3><span class="glyphicon glyphicon-user" aria-hidden="true"> </span> Email :</h3></label>
                        <input type="email" class="form-control" id="usr" placeholder="Email" name="email" required="required"/>
                  </div>
                  <div class="form-group">
                        <label for="pwd"><h3><span class="glyphicon glyphicon-lock" aria-hidden="true"> </span> Password :</h3></label>
